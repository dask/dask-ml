# Borrowed from https://github.com/pandas-dev/pandas/blob/master/pandas/_typing.py
...
AnyArrayLike = TypeVar(
    "AnyArrayLike", "ExtensionArray", "Index", "Series", "Array", np.ndarray
)
ArrayLike = TypeVar("ArrayLike", "ExtensionArray", "Array", np.ndarray)
